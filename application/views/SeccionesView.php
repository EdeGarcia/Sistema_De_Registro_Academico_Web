    ...
    <div class="row">
        <div class="col-md-12">
            <div class="jumbotron">
                ...
                <h1 class="display-3" style="margin-left: 100px;">Secciones</h1>
            </div>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-md-12 mt-2">
            ...
            <a class="btn btn-outline-success" href="<?= site_url('SeccionesController/report_secciones') ?>"> Reporte en PDF</a>
